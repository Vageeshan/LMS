...
class AddInvictaEmp extends React.Component{
                            ...
                            <div class="accordion add-employee" id="accordion-details">
                                <div class="card shadow-sm grow ctm-border-radius">
                                    <div class="card-header" id="basic1">
                                        <h4 class="cursor-pointer mb-0">
                                            <a class=" coll-arrow d-block text-dark" href="javascript:void(0)" data-toggle="collapse" data-target="#basic-one" aria-expanded="true">
                                                Basic Details Invicta Employee
                                            <br/><span class="ctm-text-sm">Happy Employee</span>
                                            </a>
                                        </h4>
                                    </div>
                                    ...
                                    <input type="text" class="form-control" placeholder="Contact Number"/>
                                                    ...
                                                    <div class="col-12 form-group mb-0" style={{paddingLeft:"22px"}}>
                                                        <p class="mb-2">Gender</p>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" class="custom-control-input" id="Male" name="Permanent" checked/>
                                                            <label class="custom-control-label" for="Male">Male</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" class="custom-control-input" id="Female" name="Permanent"/>
                                            ...
                                            <form>
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 form-group mb-0">
                                                        ...
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" class="custom-control-input" id="Contract" name="Permanent"/>
                                ...
                                <div class="card shadow-sm grow ctm-border-radius">
                                    <div class="card-header" id="headingThree">
                                        <h4 class="cursor-pointer mb-0">
                                            ...
                                            <br/><span class="ctm-text-sm">Unique username</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="submit-section text-center btn-add">
                                        <button class="btn btn-theme text-white ctm-border-radius button-1">Add New Employee</button>
                                    </div>
                                </div>
                            </div>
                        </div>
