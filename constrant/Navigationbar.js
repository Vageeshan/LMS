            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3 col-sm-3 col-6">
                    <div class="logo my-3 my-sm-0">
                        <a href="index.html">
                            <img src="https://www.samuelgnanam.com/assests/images/SGIC-NEW/logo.png" alt="logo image" class="img-fluid" width="100"/>
                        </a>
                    </div>
                </div>
                                ...
                                <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                    <a href="javascript:void(0)" data-toggle="dropdown" class=" menu-style dropdown-toggle">
                                        <div class="user-avatar d-inline-block">
                                            <img src="https://www.samuelgnanam.com/assests/images/staff//alan.png" alt="user avatar" class="rounded-circle img-fluid" width="55"/>
                                        </div>
                                    </a>
                            ...
                            <div class="user-info align-center bg-theme text-center">
                                <a href="javascript:void(0)" class="d-block menu-style text-white">
                                    <div class="user-avatar d-inline-block mr-3">
                                        <img src="http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/assets/img/profiles/img-6.jpg" alt="user avatar" class="rounded-circle img-fluid" width="55"/>
                                    </div>
                                </a>
                            </div>
